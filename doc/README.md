...
- [ALL MEMBERS]: 3 hours spent on internal project kick-off meeting, where we discussed and picked the project topic.

### Week 45 (6.Nov. - 12.Nov.)
- [ALL MEMBERS]: 3 hours spent on another meeting, this time working on the project plan

### Week 46 (13th Nov. - 19th Nov.)
- [ALL MEMBERS]: 3 hours spent on finalizing the project plan and setting up the project in Maari.
- [Tianzhong]: 2 hours spent on working with first versions of graph, vertex and edge.

### Week 47 (20th Nov. - 26th Nov.)
- [ALL MEMBERS]: 3 hours spent on working together in Maari.
- [Tianzhong]: 5 hours spent on working with first versions of graph, vertex and edge, and then with vehicle.

### Week 48 (27th Nov. - 3rd Dec.)
- [ALL MEMBERS]: 4 hours spent on working together in Maari.
- [Tianzhong]: 2 hours spent on issue #7 (const correctness problem).

### Week 49 (4th Dec. - 10th Dec.)
- [Tianzhong]: 10 hours spent working on texture files and Dijkstra's algorithm. At least 90% of the time was used at working on Dijkstra's algorithm. While the algorithm itself was relatively easy to implement and could've taken less than a few hours, a lot more time was spent due to the inexperience with C++.

### Week 50 (11th Dec. - 17th Dec.)
- [ALL MEMBERS]: At least 6 hours working together at Maari with **everyone** to finalize the project.
- [Tianzhong]: 30 hours spent: at least 7 hours with finalizing Dijkstra's algorithm, 3 hours with fixing (weird) segmentation fault when creating vehicles to the Graph and 4 hours with adding console commands for user input. Time was also spent on working with documentation, unit test and fixing minor bugs, not to mention with constant debugging.

### Week 51 (18th Dec. - 20th Dec.)
**(Predicted) work & duration below:**
